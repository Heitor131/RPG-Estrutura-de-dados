...
public class Persistencia {
    ...
    public static void salvarJogadores(LinkedList<Jogador> jogadores) {
    ...
    public static LinkedList<Jogador> carregarJogadores() {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(JOGADORES_FILE))) {
            return (LinkedList<Jogador>) ois.readObject();
